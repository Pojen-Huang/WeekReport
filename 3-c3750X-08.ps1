copy ..\LogHome\WS-NPDC-3750X-08.txt .\RAWDATA
...
echo "9 - {count} = $count"	
$filename1='Cisco Catalyst 3750X-08_(第'
$filename2='次).doc'
...
copy ..\Template\temp_3750X-08.doc .\working.doc
...
$textToReplace = @{
	...
	"{redundantNode}" = "E7-NPDC-3750X-07與E7-NPDC-3750X-08互為備援"
}
