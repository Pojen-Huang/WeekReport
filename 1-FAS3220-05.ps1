copy ..\LogHome\WS-NPDC-FAS3220-05.txt .\RAWDATA
#Get Hostname from log file
[string]$hostname = cat RAWDATA | grep WS-NPDC-FAS3220-05> | sed -n '15p' | sed 's/>//' | awk '{print $1}'
...
$sybaseArray = @()
$sybaseArray += cat RAWDATA | grep '/vol/sybase_01' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_02' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_03' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_04' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_05' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_06' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_07' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_08' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_09' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_10' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_11' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_12' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_13' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_14' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_15' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_16' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_17' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_18' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_19' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_20' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_21' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_22' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_23' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_24' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_25' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_26' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep '/vol/sybase_27' | sed -n '1p' | awk '{print $5}' | sed 's/%//'
...
Copy-Item ..\Template\temp_FAS3220-05.doc .\working.doc
...
$textToReplace = @{
	...
	"{redundantNode}" = "WS-NPDC-FAS3220-06"
}
