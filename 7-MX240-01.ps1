copy ..\LogHome\E7-NPDC-MX240-01-me0-re0.txt .\
#Get Hostname from log file
[string]$hostname = cat E7-NPDC-MX240-01-me0-re0.txt | grep Hostname | awk '{print $2}' | sed -n '1p'
echo "1 - {Hostname} = $hostname "
#Get Model
[string]$model = cat E7-NPDC-MX240-01-me0-re0.txt | grep Model | awk '{print $2}' | sed -n '1p'
echo "2 - {Model} = $model"
#Get UPtime
[string]$uptime = cat E7-NPDC-MX240-01-me0-re0.txt | grep Uptime | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sed -n '1p'
echo "3 - {Uptime} = $uptime"
#Get Serial number
[string]$serial = cat E7-NPDC-MX240-01-me0-re0.txt | grep 'Chassis' | awk '{print $2}'
$serial_1 = $serial | awk '{print $2}'
$serial_2 = $serial | awk '{print $3}'
echo "4 - {Serial_1} =  $serial_1"
echo "4 - {Serial_2} =  $serial_2"
$sid = cat E7-NPDC-MX240-01-me0-re0.txt | grep 'Serial ID' | awk '{print $4}'

#Get CPU Usage
[int]$cpu_user = cat E7-NPDC-MX240-01-me0-re0.txt | grep User | sed -n '1p' | awk '{print $2}'
[int]$cpu_kernel = cat E7-NPDC-MX240-01-me0-re0.txt | grep Kernel | sed -n '3p' | awk '{print $2}'
[int]$cpu = $cpu_user + $cpu_kernel
echo "5 - {CPU_User} = $cpu_user"
echo "6 - {CPU_Kernel} = $cpu_kernel"
echo "7 - {CPU} = $cpu"
#Get memory used
#[int]$MEM_used = cat E7-NPDC-MX240-01-me0-re0.txt | grep 'Processor Pool' | awk '{print $6}'
#echo "5 - {Memory_used} = $MEM_used"
#Get memory total
#[int]$MEM_total= cat E7-NPDC-MX240-01-me0-re0.txt | grep 'Processor Pool' | awk '{print $4}'
#echo "6 - {Memory_total} = $MEM_total"
#caculate memory usage
$MEM_usage = cat E7-NPDC-MX240-01-me0-re0.txt | grep 'Memory utilization' | awk '{print $3}' | sed -n '1p'
...
$textToReplace = @{
	...
	"{Memory}" = $MEM_usage
	"{redundantNode}" = "E7-NPDC-MX240-02-me1-re0"
	}
