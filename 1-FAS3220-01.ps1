echo "取得RAWDATA來源"
Copy-Item ..\LogHome\E7-NPDC-FAS3220-01.txt .\RAWDATA
#Get Hostname from log file
[string]$hostname = cat RAWDATA | grep E7-NPDC-FAS3220-01> | sed -n '18p' | sed 's/>//'
...
$mgmt_dr = cat RAWDATA | grep mgmt_dr | sed -n '1p' | awk '{print $5}' 
$sybaseArray = @()
$sybaseArray += cat RAWDATA | grep sybase01_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase02_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase03_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase04_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase05_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase06_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase07_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase08_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase09_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_10_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_11_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_12_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_13_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_14_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_15_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
$sybaseArray += cat RAWDATA | grep sybase_16_dr | sed -n '1p' | awk '{print $5}' | sed 's/%//'
#排序
...
$filename1='E7-FAS3220-01_(第'
$filename2='次).doc'
$filename = $filename1 + $count + $filename2
$foldername1 = "EMIC週報2017$mon$day(第"
$foldername2 ='次)'
$OutFile= $filename1 + $count + $filename2
$OutFolder="..\ReportHome\EMIC週報20171013(第210次)"
   
copy ..\Template\temp_FAS3220-01.doc .\working.doc
...
$textToReplace = @{
	...
	"{redundantNode}" = "E7-NPDC-FAS3220-02"
}
