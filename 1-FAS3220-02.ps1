echo "取得RAWDATA來源"
Copy-Item ..\LogHome\E7-NPDC-FAS3220-02.txt .\RAWDATA
#Get Hostname from log file
[string]$hostname = cat RAWDATA | grep E7-NPDC-FAS3220-02> | sed -n '18p' | sed 's/>//'
...
$OSW1_dr = cat RAWDATA | grep "/vol/OS_windows_01_dr/" | sed -n '1p' | awk '{print $5}'
$OSW2_dr = cat RAWDATA | grep "/vol/OS_windows_02_dr/" | sed -n '1p' | awk '{print $5}'
$OSL1_dr = cat RAWDATA | grep "/vol/OS_linux_01_dr/" | sed -n '1p' | awk '{print $5}'
$OSL2_dr = cat RAWDATA | grep "/vol/OS_linux_02_dr/" | sed -n '1p' | awk '{print $5}'
$EWDR = cat RAWDATA | grep "EMIC_WD_dr" | sed -n '1p' | awk '{print $5}'
$MSPDR = cat RAWDATA | grep "MSP_Monitor_FS" | sed -n '1p' | awk '{print $5}'
$ARCDBDR = cat RAWDATA | grep "arc_db_dr" | sed -n '1p' | awk '{print $5}'
$EMCDXDR = cat RAWDATA | grep "EMIC_CDX_dr" | sed -n '1p' | awk '{print $5}'
$ARCGIS = cat RAWDATA | grep "EMIC_ArcGIS_dr" | sed -n '1p' | awk '{print $5}'
$SRMPLACE = cat RAWDATA | grep "for_srm_placehold_dr" | sed -n '1p' | awk '{print $5}'
...
copy ..\Template\temp_FAS3220-02.doc .\working.doc
...
$textToReplace = @{
    ...
    "{ARCGIS}" = $ARCGIS
    "{SRMPLACE}" =$SRMPLACE
	"{redundantNode}" = "E7-NPDC-FAS3220-01"
}
