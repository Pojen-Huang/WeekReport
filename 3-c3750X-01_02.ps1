copy ..\LogHome\E7-NPDC-3750X-01_02.txt .\RAWDATA
...
$filename1='Cisco Catalyst 3750X-01_02_(第'
$filename2='次).doc'
...
copy ..\Template\temp_3750X-01_02.doc .\working.doc   
...
$textToReplace = @{
	...
	"{redundantNode}" = "E7-NPDC-3750X-01_02為STACK"
}
