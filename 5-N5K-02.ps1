copy ..\LogHome\E7-NPDC-N5596-02.txt .\RAWDATA
$sn=0
...
#Get Serial number
[string]$serial = sed -n '71p' .\RAWDATA | awk '{print $8}'
...
$textToReplace = @{
	...
	"{redundantNode}" = "E7-NPDC-N5596-02與E7-NPDC-N5596-01互為備援"
}
